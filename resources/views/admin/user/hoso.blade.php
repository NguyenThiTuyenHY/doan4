...
<div class="card shadow mb-4">
	<div class="card-header py-3 row">
		<h6 class="m-0 font-weight-bold text-primary col-lg-9">Thông tin người quản trị</h6>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-4">
				...
				<p style="text-align: center;">
					<a href="admin/logout" class="btn btn-primary"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
				</p>
			</div>
			<div class="col-4"></div>
		</div>
