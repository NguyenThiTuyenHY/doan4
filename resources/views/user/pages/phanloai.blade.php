...
<style type="text/css" media="screen">
	...
	#paginatephanloai .pagination .page-item .page-link { 
		border-radius: 50% !important;
		margin: 0 5px;
	}
</style>
<div id="bodydanhmuc">
	<div id="paginatedanhmuc" style="margin-left: 200px !important;">{{ $sps->links() }}</div>
	@foreach($sps as $sp)
	...
	@endforeach
	<div id="paginatephanloai">{{ $sps->links() }}</div>
</div>
@endsection
@section('script')
