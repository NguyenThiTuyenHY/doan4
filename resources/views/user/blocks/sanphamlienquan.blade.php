<div class="thongtin-title text-black-50"><h5><b>Sản phẩm liên quan</b></h5></div>
<div class="thongtin-content">
	<!-- it works the same with all jquery version from 1.x to 2.x -->
    <script type="text/javascript" src="./user/jquery-slider-master/js/jquery-1.9.1.min.js"></script>
    <!-- use jssor.slider.mini.js (39KB) or jssor.sliderc.mini.js (31KB, with caption, no slideshow) or jssor.sliders.mini.js (26KB, no caption, no slideshow) instead for release -->
    <!-- jssor.slider.mini.js = jssor.sliderc.mini.js = jssor.sliders.mini.js = (jssor.core.js + jssor.utils.js + jssor.slider.js) -->
    <script type="text/javascript" src="./user/jquery-slider-master/js/jssor.core.js"></script>
    <script type="text/javascript" src="./user/jquery-slider-master/js/jssor.utils.js"></script>
    <script type="text/javascript" src="./user/jquery-slider-master/js/jssor.slider.js"></script>
    <script>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1000px; height: 150px; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 150px; overflow: hidden;">
            @foreach($splq as $spl)
            <div><a href="user/chitietsanpham/idsp={{ $spl->id }}"><img u="image" src=".\upload\sanpham\{{ $spl->hinhanh }}" style="width: 220px; height: 150px;" /></a></div>
            @endforeach
        </div>       
